...
class BaseOptions:
    ...
    def initialize(self):
        # data params
        self.parser.add_argument('--class-name', type=str, default='CreativeBirds', 
        ...
        self.parser.add_argument('--dataset', type=str, default='CreativeSketch', 
        ...
        self.parser.add_argument('--out-segment', type=int, default=8,
